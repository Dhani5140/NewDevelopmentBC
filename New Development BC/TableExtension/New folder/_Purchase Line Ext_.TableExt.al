tableextension 80101 "Purchase Line Ext" extends "Purchase Line"
{
    fields
    {
        ...
        field(50023; "WHT Product Posting Group"; Code[20])
        {
            ...
            TableRelation = "WHT Posting Setup"."WHT Product Posting Group"
        WHERE(
            "WHT Business Posting Group" = FIELD("WHT Business Posting Group")
        ); // Filter dropdown sesuai Business Posting Group

            trigger OnValidate()
            var
                WHTPostingSetup: Record "WHT Posting Setup";
            begin
                // Debug untuk melihat nilai pilihan
                Message('Selected WHT Product Posting Group: %1', "WHT Product Posting Group");
                ...
                if WHTPostingSetup.FindFirst() then begin
                    ...
                    Message('Debug: WHT %% Updated to: %1', "WHT %");
                end else
